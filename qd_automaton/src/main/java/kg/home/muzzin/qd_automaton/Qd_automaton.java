...
public class Qd_automaton {
    ...
    public static void run(int seed) throws IOException {
...
//init population
            ...
            }
            {
                ...
                a.export("novel_best_"+seed+".png");
            }
        }
    }

    public static void runOptimal(int seed) throws IOException {
        Random r = new Random(seed);
        float blackPercentage = 10;
        //init population
        ...
        }
        {
            ...
            var ba = best.getAutomaton();
            for (int i = 0; i < turns; i++) {
                //System.out.print(a.toString());
                ba.timeStep(ruleset);
            }
            System.out.println("Best Optimal Search Height:" + ba.getLastNonRepeatingGeneration());
            ba.export("optimal_best_"+seed+".png");
        }
    }

    public static void runRandom(int seed) throws IOException {
        Random r = new Random(seed);
        float blackPercentage = 10;
        ...
        ra.export("random_best_"+seed+".png");
    }
}
